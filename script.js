// URLs das planilhas
const PLANILHA_ESTABELECIMENTO = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSKb_aTnheGghAgZbCbBq-rnSi-4dgSSv3R5BCbxk_t35rabCZjc-gbEDMXVIw42Pc1mPOX48x51Zk2/pub?gid=0&single=true&output=csv';
const PLANILHA_CATEGORIAS = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSKb_aTnheGghAgZbCbBq-rnSi-4dgSSv3R5BCbxk_t35rabCZjc-gbEDMXVIw42Pc1mPOX48x51Zk2/pub?gid=1058001994&single=true&output=csv';
const PLANILHA_ITENS = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSKb_aTnheGghAgZbCbBq-rnSi-4dgSSv3R5BCbxk_t35rabCZjc-gbEDMXVIw42Pc1mPOX48x51Zk2/pub?gid=821772599&single=true&output=csv';
...
function desabilitarBotoesAdicionar() {
    ...
    botoes.forEach(botao => {
        if (!botao.disabled) {
            botao.disabled = true;
            botao.classList.remove('bg-gray-500', 'hover:bg-gray-600');
...
function habilitarBotoesAdicionar() {
    ...
    botoes.forEach(botao => {
        ...
        if (item && (item.disponivel === 'TRUE' || item.disponivel === true || item.disponivel === 'true')) {
            ...
            botao.classList.add('bg-gray-500', 'text-white', 'hover:bg-gray-600');
